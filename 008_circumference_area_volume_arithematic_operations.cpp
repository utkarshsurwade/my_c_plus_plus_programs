...
int main()
{
    ...
    cout<<"Then the volume of the circle is:"<<(4/3.0)/*while dividing ,in order to get quotient in decimal form ,we have to make one part of the function in decimal form[here "3.0"]*/*pi*pow(radius,3)<<endl;
