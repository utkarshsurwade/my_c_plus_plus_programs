...
//(loop control variable does'nt keep track of output instead it looks for a certain value in order to stop the loop)
...
int main()
{
    ...
    {
        product += num1;//body or statement that does some type of work
           //(take the value of num1 and add it into the current value of product and keep on doing this until the loop stops)

        cout<<num1<<" + "<<no*num1-num1<<"="<<product<<"\n";//so that the program's output looks neat
                                                           //(in order to verify the loop)[in order to show the steps]
